...
T = [
 {"slug":"national-education-policy-2020","tag":"Policy","read":"7 min read","cta":"/pyq/",
  ...
  "sec":[("The 5+3+3+4 school structure","NEP replaces the old 10+2 structure with a 5+3+3+4 design — the Foundational stage (ages 3–8), Preparatory (8–11), Middle (11–14) and Secondary (14–18) stages. Crucially, it brings early childhood care and education (ages 3–6) into the formal school system for the first time, recognising that over 85% of a child's brain development occurs before age six."),
    ...
    ("The four-year degree and Academic Bank of Credits","In higher education, NEP introduces a flexible undergraduate structure with multiple entry and exit points: a certificate after one year, a diploma after two, a bachelor's degree after three, and a four-year degree 'with research' for those who continue. Credits earned are digitally stored in an Academic Bank of Credits (ABC), so a student can pause and resume studies or transfer between institutions without losing progress. The long-term vision is to move towards large multidisciplinary universities and autonomous colleges, gradually phasing out the standalone 'affiliation' system and giving institutions graded autonomy."),
    ("Teachers, assessment and PARAKH","NEP places teachers at the centre of reform. It proposes a four-year integrated Bachelor of Education (B.Ed.) as the minimum qualification for school teachers by 2030, merit-based recruitment, and National Professional Standards for Teachers. On assessment, the policy shifts from high-stakes rote testing towards competency-based, formative evaluation that tests understanding and application. A new national assessment centre, PARAKH, is tasked with setting norms and standards, and school students are to take census-based assessments at Grades 3, 5 and 8 to track learning outcomes."),
    ("Technology, inclusion and Indian languages","A National Educational Technology Forum (NETF) is envisaged to guide the use of technology, alongside digital platforms like DIKSHA for e-content. The policy gives special attention to Socio-Economically Disadvantaged Groups (SEDGs), proposing a Gender-Inclusion Fund and Special Education Zones in disadvantaged regions to widen access. It strongly promotes Indian languages, the study of classical languages and literature, the standardisation of Indian Sign Language, and the setting up of institutions to strengthen Sanskrit and other languages — reflecting its emphasis on rootedness in Indian culture alongside global competence."),
    ("Challenges and criticisms","Despite wide praise, NEP faces real hurdles. The 6% of GDP spending goal has been an aspiration since the 1968 policy and remains unmet, raising doubts about funding. Critics worry that a single regulator like HECI could centralise control, that the three-language formula could reignite language politics in some states, and that ambitious targets such as universal foundational literacy by 2025 or a 50% GER by 2035 require enormous infrastructure and teacher capacity. Because education is a Concurrent subject, uneven adoption across states could widen rather than narrow disparities — making implementation, not vision, the real test of NEP 2020.")],
 ...
 {"slug":"preamble-of-indian-constitution","tag":"Polity","read":"5 min read","cta":"/pyq/polity/",
  ...
  "sec":[("Key words and their meaning","The Preamble declares India a Sovereign, Socialist, Secular, Democratic Republic and resolves to secure to all citizens Justice (social, economic, political), Liberty (of thought, expression, belief, faith and worship), Equality (of status and opportunity), and to promote Fraternity assuring the dignity of the individual and the unity and integrity of the nation. The words 'Socialist', 'Secular' and 'Integrity' were added later by the 42nd Amendment Act, 1976."),
    ...
    ("Meaning of the key terms","Each keyword carries deep meaning. 'Sovereign' means India is internally and externally free, subject to no external authority. 'Socialist' — added in 1976 — refers to democratic socialism and a mixed economy where public and private sectors coexist, aiming to reduce inequality, rather than communist state ownership. 'Secular' means the State has no official religion and treats all faiths equally, a principle the Supreme Court affirmed as part of the basic structure in the S.R. Bommai case (1994). 'Democratic' covers not just political democracy (universal adult franchise, elected government) but also social and economic democracy. 'Republic' means the head of state — the President — is elected, not hereditary."),
    ("The objectives — Justice, Liberty, Equality, Fraternity","The Preamble's ideals were drawn from the objectives of the French Revolution and the ideals of the Indian freedom struggle. Justice is envisaged in three forms — social, economic and political — inspired by the Russian Revolution. Liberty guarantees freedom of thought, expression, belief, faith and worship. Equality assures equal status and opportunity to all citizens. Fraternity promotes a sense of brotherhood, assuring the dignity of the individual and the unity and integrity of the nation. Together, these four ideals are meant to be understood not in isolation but as a 'trinity' that sustains a just and inclusive society.")],
 ...
 {"slug":"monetary-policy-repo-rate","tag":"Economy","read":"6 min read","cta":"/pyq/economy/",
  ...
  "intro":"Monetary policy is the process by which the Reserve Bank of India (RBI) manages the supply of money and the cost of credit in the economy to achieve price stability while supporting growth. Since 2016, India follows a formal flexible inflation-targeting framework, in which the RBI adjusts its key policy rate — the repo rate — to keep retail inflation close to a legally mandated target. Monetary policy is one of the two main arms of macroeconomic management, the other being fiscal policy run by the government.",
  "tldr":"Monetary policy is the RBI's management of money supply and interest rates to control inflation and support growth. Its main tool is the repo rate, decided by a six-member Monetary Policy Committee (MPC) under a flexible inflation-targeting framework that aims for 4% CPI inflation, within a 2-6% band.",
  "facts":[("Conducted by","Reserve Bank of India (RBI)"),("Decided by","6-member Monetary Policy Committee (MPC)"),("Main tool","Repo rate"),("Target","4% CPI inflation (+/- 2%)"),("Framework since","2016 (flexible inflation targeting)"),("Other tools","Reverse repo, CRR, SLR, OMOs, MSF"),("Stance types","Accommodative, neutral, tightening")],
  "sec":[("Objectives of monetary policy","The primary objective of India's monetary policy is price stability — keeping inflation low and stable — while keeping in mind the objective of economic growth. Stable prices protect the purchasing power of money, encourage saving and investment, and provide a predictable environment for businesses. Monetary policy also indirectly influences employment, the exchange rate and financial stability, so the RBI must balance multiple goals when setting its stance."),
    ("The repo rate and how it works","The repo (repurchase) rate is the interest rate at which the RBI lends short-term funds to commercial banks against government securities. It is the single most important policy tool. When the RBI raises the repo rate, borrowing becomes costlier for banks, which pass on higher rates to customers — this cools demand and helps bring down inflation (a 'tightening' or 'hawkish' stance). When it cuts the repo rate, credit becomes cheaper, boosting spending and investment to support growth (an 'accommodative' or 'dovish' stance). The reverse repo rate is the rate at which banks park surplus funds with the RBI."),
    ("Quantitative tools — CRR, SLR and liquidity","Besides the repo rate, the RBI uses reserve requirements. The Cash Reserve Ratio (CRR) is the share of deposits banks must keep as cash with the RBI, earning no interest; raising it drains liquidity from the system. The Statutory Liquidity Ratio (SLR) is the share of deposits banks must hold in liquid assets like government securities. The RBI also manages day-to-day liquidity through Open Market Operations (buying/selling government securities), the Marginal Standing Facility (MSF), and the Liquidity Adjustment Facility (LAF)."),
    ("Qualitative and modern tools","In addition to quantitative tools that affect the overall quantity of credit, the RBI uses qualitative or selective tools that influence the direction of credit — such as margin requirements, moral suasion (persuading banks informally) and priority-sector lending norms. Forward guidance, where the RBI signals its likely future stance, has also become an important tool for shaping market expectations."),
    ("The Monetary Policy Committee (MPC)","Following amendments to the RBI Act in 2016, monetary policy decisions are taken by a six-member Monetary Policy Committee. It comprises three members from the RBI (including the Governor, who chairs it, and a Deputy Governor) and three external members appointed by the central government. Decisions are by majority vote; in a tie, the Governor has a casting vote. The MPC meets at least four times a year, and this committee-based approach was designed to make monetary policy more transparent, accountable and less dependent on a single individual."),
    ("The inflation-targeting framework","Under the framework, the government, in consultation with the RBI, sets a CPI (Consumer Price Index) inflation target — currently 4%, with a tolerance band of plus or minus 2% (i.e., 2% to 6%). If average inflation stays outside this band for three consecutive quarters, the RBI is deemed to have failed and must report to the government explaining the reasons and the remedial steps. This accountability mechanism anchors inflation expectations and gives the RBI a clear, measurable mandate."),
    ("Transmission and its challenges","For monetary policy to work, changes in the repo rate must be passed on to actual lending and deposit rates faced by households and firms — a process called monetary transmission. In India, transmission has often been slow and incomplete because of factors like high small-savings interest rates, stressed bank balance sheets and the structure of deposits. To improve it, the RBI has linked many floating-rate retail loans to an external benchmark such as the repo rate, so that policy changes reach borrowers faster."),
    ("Monetary vs fiscal policy","Monetary policy (run by the RBI, using interest rates and liquidity) and fiscal policy (run by the government, using taxation and spending) must work together for stable growth. When they pull in opposite directions — for example, loose fiscal policy fuelling inflation while the RBI tries to control it — the economy can face difficulties. Coordinating the two, especially in managing government borrowing and inflation, is a recurring policy challenge and a favourite theme in economics questions.")],
  "why":"Repo rate, reverse repo, CRR/SLR, MSF, the MPC's composition (3 RBI + 3 external members) and the 4% (+/- 2%) inflation target are among the most frequently tested Economy facts in Prelims. Monetary transmission and the monetary-fiscal coordination debate are strong Mains topics.",
  "take":["Monetary policy is run by the RBI to control inflation while supporting growth.","The repo rate is the main tool; raising it fights inflation, cutting it supports growth.","CRR, SLR, OMOs and MSF are other tools to manage liquidity.","A six-member MPC (3 RBI + 3 external members) decides the policy rate by majority vote.","The CPI inflation target is 4%, with a 2-6% tolerance band.","Slow monetary transmission is a key challenge, addressed via external benchmark-linked loans."],
  "faq":[("What is the repo rate?","The repo rate is the interest rate at which the RBI lends short-term funds to commercial banks against government securities; it is the RBI's main policy tool."),
    ("Who sets the policy interest rate in India?","A six-member Monetary Policy Committee (MPC), chaired by the RBI Governor, sets the policy repo rate by majority vote."),
    ("What is India's inflation target?","4% CPI inflation, with a tolerance band of plus or minus 2% (i.e., between 2% and 6%)."),
    ("What is the difference between repo and reverse repo rate?","The repo rate is the rate at which the RBI lends to banks; the reverse repo rate is the rate at which banks park their surplus funds with the RBI."),
    ("What is monetary transmission?","The process by which changes in the RBI's policy rate are passed on to the actual lending and deposit rates faced by households and businesses.")]},
 ...
 {"slug":"reserve-bank-of-india-functions","tag":"Economy","read":"6 min read","cta":"/pyq/economy/",
  ...
  "intro":"The Reserve Bank of India (RBI), established on 1 April 1935 under the RBI Act, 1934, is the country's central bank and the apex monetary authority. Originally set up during British rule and nationalised in 1949, it is often called the 'banker's bank' and the 'lender of last resort'. The RBI sits at the heart of India's financial system, managing the currency, steering monetary policy, regulating banks and acting as banker and debt manager to the government.",
  "tldr":"The RBI, established in 1935 and nationalised in 1949, is India's central bank. Its main functions are formulating monetary policy, issuing currency, regulating and supervising banks, acting as banker to the government and to banks, managing foreign exchange and public debt, and serving as the lender of last resort.",
  "facts":[("Established","1 April 1935 (RBI Act, 1934)"),("Nationalised","1949"),("Headquarters","Mumbai"),("Head","Governor (assisted by Deputy Governors)"),("Currency issued","All notes except ₹1 note & coins (issued by Govt.)"),("Monetary policy","Set by the 6-member MPC"),("Inflation target","4% CPI (+/- 2%)")],
  "sec":[("Monetary authority","The RBI's foremost role is to formulate and implement monetary policy — controlling the supply of money and the cost of credit to achieve price stability while keeping in mind the objective of growth. Since 2016, it operates under a formal flexible inflation-targeting framework, with policy decisions taken by a six-member Monetary Policy Committee (MPC). By adjusting the repo rate and other tools, the RBI influences interest rates across the economy, aiming to keep retail (CPI) inflation at 4%, within a band of 2-6%."),
    ...
    ("Governance and autonomy","The RBI is headed by a Governor, assisted by Deputy Governors, and is overseen by a Central Board of Directors. While it works closely with the government, its operational autonomy — especially in monetary policy — is considered vital for credibility. Debates periodically arise over the balance between RBI autonomy and government influence, for instance over the transfer of surplus reserves or the setting of interest rates, making central-bank independence a recurring theme in economic governance.")],
  "why":"The RBI's establishment year, its functions — currency issue, monetary policy, banking regulation, its role as banker to the government and lender of last resort — and the ₹1 note exception are commonly tested in Prelims, often in statement-based questions. The MPC, inflation targeting and RBI autonomy are strong Mains themes on the economy and institutions.",
  "take":["The RBI was established in 1935 and nationalised in 1949; its headquarters are in Mumbai.","It issues all currency notes except the ₹1 note and coins, which the government issues.","Monetary policy is set by a six-member MPC, targeting 4% CPI inflation (+/- 2%).","It is banker to the government, banker to banks and the lender of last resort.","It regulates banks and NBFCs and manages foreign exchange under FEMA.","Central-bank autonomy, especially in monetary policy, is key to its credibility."],
  "faq":[("When was the RBI established?","The Reserve Bank of India was established on 1 April 1935 under the RBI Act, 1934, and was nationalised in 1949."),
    ("Who issues one-rupee notes and coins in India?","The Government of India issues one-rupee notes and coins; the RBI issues all other currency notes but puts the government's notes and coins into circulation."),
    ("What does 'lender of last resort' mean?","It means the RBI can lend to a solvent bank facing a temporary liquidity shortage when it cannot borrow from anywhere else, preventing a wider financial panic."),
    ("Who decides monetary policy in India?","A six-member Monetary Policy Committee (MPC), chaired by the RBI Governor, decides the policy repo rate under the inflation-targeting framework."),
    ("Which laws empower the RBI to regulate banks and forex?","The Banking Regulation Act, 1949 (for banks) and the Foreign Exchange Management Act, 1999 (for foreign exchange).")]},
